...
class MyVAD:
    ...
    path : str
        path to audio path
    energy_coef : float, default 0.3
        sample value coefficient that defines silence and non-silence samples
    ...
    def __init__(self, path,
        ...
        self.sample_threshold = np.max(self.samples) / energy_coef
...
if __name__ == '__main__':
    ...
    voice_timestamps = MyVAD(path=path).sample_silence_split()
