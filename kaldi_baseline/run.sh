...
export PATH=/home/dima/kaldi/tools/python:${PATH}
export IRSTLM=/home/dima/kaldi/tools/irstlm
export PATH=${PATH}:${IRSTLM}/bin
export LIBLBFGS=/home/dima/kaldi/tools/liblbfgs-1.10
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:-}:${LIBLBFGS}/lib/.libs
export SRILM=/home/dima/kaldi/tools/srilm
export PATH=${PATH}:${SRILM}/bin:${SRILM}/bin/i686-m64


nj=12       # number of parallel jobs - 1 is perfect for such a small dataset
